	...
	return (
		<div className="space-y-8 fade-in px-6 py-4">
			...
			<div className="flex items-center justify-between">
				<div>
					<h1 className="text-3xl font-bold text-white">Beslenme 🍽️</h1>
					<p className="text-slate-400 mt-1">
						Öğünlerini ve kalorilerini takip et.
					</p>
				</div>
							...
							>
								...
								<div className="mt-4 grid grid-cols-3 gap-4 text-sm">
									...
									<div>
										...
										<span className="text-xs text-slate-500">Karbonhidrat</span>
									</div>
									<div>
										<p className="text-white font-bold">{meal.fats} g</p>
										<span className="text-xs text-slate-500">Yağ</span>
									</div>
								</div>
							</div>
						))
					...
					<div className="bg-gradient-to-b from-slate-800/80 to-slate-900/80 border border-slate-700 p-6 rounded-2xl backdrop-blur-md shadow-xl">
						...
						<form action={addMeal} className="space-y-4">
							...
							<p className="text-xs text-center text-slate-500">
								Makrolar opsiyonel, tarih otomatik atanır.
							</p>
						</form>
					</div>
				</div>
